...
public class Microsoft_training extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_microsoft_training);

        Animation animation = AnimationUtils.loadAnimation(this, R.anim.swing_up_left);
        CardView anim = (CardView) findViewById(R.id.microsoft1);
        CardView anim1 = (CardView) findViewById(R.id.microsoft2);
        ...
        collapsingToolbar.setTitle(" Java Training ");
