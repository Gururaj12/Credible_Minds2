package in.wexos.varun.credible_minds.db;
...
import in.wexos.varun.credible_minds.Quiz.Sap;
import in.wexos.varun.credible_minds.model.Question;
...
public class DBAdapter_Sap extends SQLiteOpenHelper {
    ...
    public DBAdapter_Sap(Sap context) {
