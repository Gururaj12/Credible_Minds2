...
public class Testing_training extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_testing_training);

        Animation animation = AnimationUtils.loadAnimation(this, R.anim.swing_up_left);
        CardView anim = (CardView) findViewById(R.id.testing1);
        CardView anim1 = (CardView) findViewById(R.id.testing2);
        ...
        collapsingToolbar.setTitle(" Testing Training ");
